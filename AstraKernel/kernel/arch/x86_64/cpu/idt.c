...
extern void irq0_stub(interrupt_frame_t *);  extern void irq1_stub(interrupt_frame_t *);
extern void irq2_stub(interrupt_frame_t *);  extern void irq3_stub(interrupt_frame_t *);
extern void irq4_stub(interrupt_frame_t *);  extern void irq5_stub(interrupt_frame_t *);
extern void irq6_stub(interrupt_frame_t *);  extern void irq7_stub(interrupt_frame_t *);
extern void irq8_stub(interrupt_frame_t *);  extern void irq9_stub(interrupt_frame_t *);
extern void irq10_stub(interrupt_frame_t *); extern void irq11_stub(interrupt_frame_t *);
extern void irq12_stub(interrupt_frame_t *); extern void irq13_stub(interrupt_frame_t *);
extern void irq14_stub(interrupt_frame_t *); extern void irq15_stub(interrupt_frame_t *);

__attribute__((interrupt)) static void default_handler(interrupt_frame_t *frame) {
    (void)frame;
    while (1) { __asm__ volatile("cli; hlt"); }
}

void idt_init(void) {
    for (int i = 0; i < 256; ++i) set_gate(i, default_handler, 0x8E);
    ...
    set_gate(32, irq0_stub, intr);  set_gate(33, irq1_stub, intr);
    set_gate(34, irq2_stub, intr);  set_gate(35, irq3_stub, intr);
    set_gate(36, irq4_stub, intr);  set_gate(37, irq5_stub, intr);
    set_gate(38, irq6_stub, intr);  set_gate(39, irq7_stub, intr);
    set_gate(40, irq8_stub, intr);  set_gate(41, irq9_stub, intr);
    set_gate(42, irq10_stub, intr); set_gate(43, irq11_stub, intr);
    set_gate(44, irq12_stub, intr); set_gate(45, irq13_stub, intr);
    set_gate(46, irq14_stub, intr); set_gate(47, irq15_stub, intr);
