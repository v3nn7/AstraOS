...
__attribute__((unused)) static int usb_manager_init(void) {
    klog_printf(KLOG_INFO, "usb: manager init");
    return usb_core_init();
}

__attribute__((unused)) static int usb_manager_register_host(usb_host_controller_t *hc) {
    return usb_host_register(hc);
}

__attribute__((unused)) static int usb_manager_unregister_host(usb_host_controller_t *hc) {
    return usb_host_unregister(hc);
}

__attribute__((unused)) static usb_host_controller_t *usb_manager_find(usb_controller_type_t type) {
